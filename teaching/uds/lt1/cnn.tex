...
\begin{itemize}
	...
	\begin{center}
	\includegraphics[height=0.5\textheight]{images/apple_kernel_convolution.jpg}
	\end{center}
	\pause
...
\begin{itemize}
	\item \textbf{Pooling} takes the maximum value (max pooling) or arithmetic average (average pooling) of a small block of nodes
	\begin{center}

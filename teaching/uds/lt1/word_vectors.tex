...
\begin{center}
	\includegraphics[height=0.40\textheight]{images/hermann-blunsom2013_fig3.pdf}
\end{center}
\vspace*{-1.2em}
\begin{itemize}
	\item \href{https://www.aclweb.org/anthology/C12-1089.pdf}{Klementiev et al (2012)}
	\item \href{http://arxiv.org/abs/1312.6173}{BiCVM} (Hermann \& Blunsom, 2013) (\href{https://github.com/karlmoritz/bicvm}{software})
	\item \href{http://papers.nips.cc/paper/5270-an-autoencoder-approach-to-learning-bilingual-word-representations}{Bilingual autoencoders} (Chandar et al, 2014) (\href{http://sarathchandar.in/data/corr_net.zip}{software})
	\item \href{http://arxiv.org/abs/1410.2455}{BilBOWA} (Gouws et al, 2014) (\href{https://github.com/gouwsmeister/bilbowa}{software})
	\item \href{https://www.aclweb.org/anthology/D15-1131.pdf}{Trans-gram} (Coulmance et al, 2015)
\end{itemize}
\end{frame}

...
\begin{itemize}
	...
	\item This specific RNN is called an \textbf{Elman network} (or \textbf{simple RNN})
\end{itemize}
\end{minipage}
 & 
%\begin{scalebox}{0.6}{%
...
\end{itemize}
\teeny{Image courtesy of \url{http://deeplearning.net/tutorial/lstm.html}.  The symbol $\odot$ is the Hadamard product (a.k.a.\ elementwise multiplication), which just multiplies corresponding elements of two matrices and returns another matrix of their products.}
\end{frame}

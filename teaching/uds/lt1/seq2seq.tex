...
\begin{center}
\includegraphics[width=0.40\textwidth]{images/cho_nvidia_fig-2_enc-dec.png}\hspace*{-1.0em}%
\end{center}
	\pause
...
\begin{center}
\includegraphics[width=0.60\textwidth]{images/cho_nvidia_fig-2_birnn.png}\hspace*{-1.0em}%
\end{center}
\end{itemize}
...
\begin{itemize}
	...
	\pause
\begin{center}
\includegraphics[width=0.40\textwidth]{images/keanu_what_if_nnet.jpg}\hspace*{-1.0em}%
\end{center}
	\pause
...
\begin{center}
\includegraphics[width=0.70\textwidth]{images/cho_nvidia_fig-3_attention.png}\hspace*{-1.0em}%
\end{center}
	\pause
	\item The attention weights can also function as soft word alignments
\end{itemize}
\teeny{Image courtesy of \url{http://devblogs.nvidia.com/parallelforall/introduction-neural-machine-translation-gpus-part-3}}
\end{frame}
...
\end{itemize}
\begin{center}
\includegraphics[height=0.71\textheight]{images/cho_nvidia_fig-8_image_caption.png}\hspace*{-1.0em}%
\end{center}
\teeny{Image courtesy of \url{http://devblogs.nvidia.com/parallelforall/introduction-neural-machine-translation-gpus-part-3}}
\end{frame}
...
\begin{center}
\includegraphics[width=1.07\textwidth]{images/xu-etal2015_icml_fig4.jpg}\hspace*{-1.0em}%
\end{center}
...
\begin{center}
\includegraphics[width=0.90\textwidth]{images/xu-etal2015_icml_fig10b.jpg}\hspace*{-1.0em}%
\end{center}
\teeny{Images courtesy of \url{http://arxiv.org/abs/1502.03044}}
\end{frame}
